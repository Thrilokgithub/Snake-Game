...
public class Panel extends JPanel implements ActionListener {
    ...
    public void spawnfood(){
        //we get a random multiple of 50 between 0 and 1200(or ill fetch from the current frame size)
    ...
    public void draw(Graphics graphic){
        if(flag){
            ...
            for(int i = 0; i < length; i++){
                ...
                //for the shape
                graphic.fillOval(xsnake[i], ysnake[i], 55, 55);
            }
    ...
    //finally the action performed will repeat the work again
